...
class n9938a(object):
    ...
    def __init__(self):
        ...
        self.pub_rbw = rospy.Publisher("/dev/n9938a/__IP__/rbw_query_cmd",Float64,queue_size=1)
        self.pub_vbw = rospy.Publisher("/dev/n9938a/__IP__/vbw_query_cmd",Float64,queue_size=1)
    ...
    def resol_bw_auto_set(self,auto):
        self.flag = False
        time.sleep(0.3)
        ret = Int(self.sa.resolution_bw_auto_set(auto))
        time.sleep(0.1)
        self.flag = True
        return
